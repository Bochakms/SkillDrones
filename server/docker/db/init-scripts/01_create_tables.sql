...
-- Таблица для хранения предварительно рассчитанных метрик
...
(
    ...
    flight_density       DOUBLE PRECISION,
    zero_days_count      INTEGER,
...
-- Пространственный индекс для регионов
